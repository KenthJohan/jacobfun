...
def inverse_kinematics(target_pos, initial_angles, tolerance=1e-5, max_iterations=1000, alpha=0.1):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        final_angles = inverse_kinematics(current_pos, initial_angles)
